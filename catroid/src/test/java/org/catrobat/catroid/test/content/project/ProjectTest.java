...
public class ProjectTest {
	...
	@Test
	public void testSetFrameSize_defaultScreenSize() {
		boolean landscapeMode = false;
		boolean isCastProject = false;
	...
	@Test
	public void testSetFrameSize_landscape() {
	...
	@Test
	public void testSetFrameSize_landscape_widthSmallerHeight() {
		boolean landscapeMode = true;
		boolean isCastProject = false;
		int height = 1500;
		int width = 1000;
	...
	@Test
	public void testSetFrameSize_cast() {
		boolean landscapeMode = false;
