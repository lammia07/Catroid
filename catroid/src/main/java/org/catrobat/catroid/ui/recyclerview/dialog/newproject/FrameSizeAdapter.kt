...
class FrameSizeAdapter(
    private var context: Context, private var landscape: Boolean, private var cm: Boolean
) : BaseAdapter() {
    ...
    override fun getItem(position: Int): FrameSize = if (position == 0) currentScreen else
        FrameSize.FrameSizes[position - 1]
